  ...
  return(
    <nav className="absolute w-full bg-transparent h-20" >
      <div className="flex  justify-between  w-full h-full max-w-7xl m-auto items-center px-4" >
        ...
        <div className='hidden lg:flex h-full items-center gap-4 mr-10' >
        ...
        <div className='hidden lg:flex lg:w-14 lg:justify-between lg:items-center'>
          <a href="https://www.instagram.com/bobello.dev" target='_blank' rel='noopener noreferrer'>
            <FaInstagram />
          </a>
          <a href="https://api.whatsapp.com/send?phone=5547999950797" target='_blank' rel='noopener noreferrer'>
            <FaWhatsapp />
          </a>
        </div> 
