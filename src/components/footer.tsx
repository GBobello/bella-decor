  ...
  return(
    <footer className="w-full">
      <div className="w-full bg-slate-400 h-80 flex flex-col lg:flex-row">
        ...
        <FooterItems title='Endereço' description='Rua tal com a esquina aquela'/>
      </div>
      <div className="w-full bg-slate-800 h-full text-center">
        <p className="text-sm text-slate-100 p-3" >Copyright 2024 &copy; Bella Decor | Todos os direitos reservados.</p>
      </div>
    </footer>    
  )
}