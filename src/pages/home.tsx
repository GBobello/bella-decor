  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex items-center justify-center flex-col md:flex lg:flex-row w-full h-738 p-6">
        <div className="">
          <h2 className="text-2xl ml-3">Sobre nós</h2>
          <div className="p-4 items-center justify-center lg:w-520">
            <p>
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been the industry's standard dummy text
              ever since the 1500s, when an unknown printer took a galley of
              h-screen              type and scrambled it to make a type specimen book. It has
